...
{include file='header.tpl'}
    <div id="user">
        ...
        <form action="" >
            ...
            <label>密　码：<input type="password" name="password" class="password"/></label>
            <label>验证码：<input type="text" name="code" class="code"/></label>
            <img src="images/vdimgck.png" alt="验证码">
            <p><input type="submit" name="send" value="登录" class="submit"/><a href="###">注册会员</a> <a href="###">忘记密码</a> </p>
        </form>
        <h3>最近登录会员<span>__________________________</span></h3>
        <dl>
            <dt><image src="images/01.gif" alt="头像"></dt>
            <dd>殷桃小丸子</dd>
        </dl>
        <dl>
            <dt><image src="images/01.gif" alt="头像"></dt>
    ...
    <div id="pic">
        <img src="images/adverleft.png" alt="广告">
    </div>
    <div id="rec">
        <h2>特别推荐</h2>
        <ul>
    ...
    <div id="picnews">
        <h2>图文资讯</h2>
        <dl>
            <dt><a href="###"><img src="images/pic1.png" alt="图文资讯"/></a></dt>
